...
import { ArrowLeft, Sparkles, FileText, Download, AlertCircle } from "lucide-react";
...
const ATSResumeBuilder = () => {
  ...
  const hasReachedLimit = !canUseFeature('resume_building');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {showUpgradeAlert && (
          <Alert variant="destructive" className="mb-6 border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950">
            ...
            <AlertDescription>
              {getLimitMessage('resume_building')}
              <div className="mt-2">
        ...
        <div className="bg-gradient-to-br from-emerald-50 via-indigo-50 to-blue-50 dark:from-emerald-950 dark:via-indigo-950 dark:to-blue-950 border-emerald-200 dark:border-emerald-800 rounded-xl border shadow-md px-4 py-5 mb-6 sm:px-7 max-w-3xl mx-auto text-center transition-all duration-300">
          ...
          {subscriptionData.tier === "free" && (
            <div className="mt-3 bg-orange-50 dark:bg-orange-950 border border-orange-200 dark:border-orange-800 rounded-lg p-3">
              <p className="text-sm text-orange-700 dark:text-orange-300 font-medium">
                <span className="font-bold">Free Plan:</span> {usageData.totalUsage.resume_building}/1 lifetime resume builds used
                {hasReachedLimit && <span className="block mt-1 font-semibold text-red-600 dark:text-red-400">Lifetime limit reached!</span>}
              </p>
            </div>
          )}
        </div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm shadow-lg border-emerald-200">
              ...
              <CardContent>
                <ATSResumeForm 
                  ...
                  disabled={hasReachedLimit && subscriptionData.tier === "free"}
                />
              </CardContent>
            </Card>
          </div>
