      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-x-hidden">
        ...
        <div className="relative z-10 py-4 sm:py-6 px-3 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-2 sm:gap-4">
                  <Link to="/" className="flex items-center group">
                    <span className="font-brand text-2xl sm:text-4xl lg:text-5xl font-extrabold text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-emerald-600 bg-clip-text animate-fade-in drop-shadow-lg tracking-tight select-none group-hover:scale-105 transition-transform duration-300">
                      Resulient
                    </span>
                  </Link>
                  <div className="flex flex-col gap-2">
                    <Badge className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-semibold">
              ...
              <Card className="bg-gradient-to-br from-white/90 via-emerald-50/50 to-blue-50/50 dark:from-slate-900/90 dark:via-slate-800/50 dark:to-slate-900/50 border-2 border-emerald-200/60 dark:border-emerald-800/40 shadow-2xl backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6 lg:p-8">
                  <div className="text-center space-y-4 sm:space-y-6">
                    <h1 className="text-xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-slate-800 via-emerald-700 to-blue-700 dark:from-slate-100 dark:via-emerald-300 dark:to-blue-300 bg-clip-text text-transparent leading-tight">
                      Build Your Perfect ATS Resume
                    </h1>
                    
                    <p className="text-sm sm:text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed px-2">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8">
                      {features.map((feature, index) => (
                        <div 
                          key={index}
                          className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r ${feature.color} text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-default`}
                        >
                    ...
                    {subscription.tier === "free" && (
                      <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border border-amber-200 dark:border-amber-800/50 rounded-xl mx-2 sm:mx-0">
                        <div className="flex items-center justify-center gap-2 text-amber-700 dark:text-amber-300 font-semibold text-sm sm:text-base">
            ...
            {/* Main Content - Single Form Section */}
            <div className="max-w-4xl mx-auto mt-6 sm:mt-8">
              <Card className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm shadow-xl border-2 border-emerald-200/60 dark:border-emerald-800/40 hover:shadow-2xl transition-all duration-300">
                <CardHeader className="pb-4 sm:pb-6 px-4 sm:px-6">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center gap-3 text-lg sm:text-2xl font-bold">
                    <div className="flex items-center gap-3">
                      <div className="p-2 sm:p-3 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-xl shadow-lg">
                    ...
                    <Badge variant="secondary" className="sm:ml-auto bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300 px-2 sm:px-3 py-1 text-xs sm:text-sm w-fit">
