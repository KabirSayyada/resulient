    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 dark:from-blue-950 dark:via-purple-950 dark:to-pink-950 px-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-100 dark:border-gray-700">
        <div className="mb-6 text-center">
          ...
          <h2 className="text-3xl font-extrabold text-primary dark:text-primary-foreground mb-2 mt-2">Welcome Back!</h2>
          ...
          <ul className="mt-3 mb-0 space-y-1 text-left text-sm text-indigo-600 dark:text-indigo-400 font-medium ml-6">
