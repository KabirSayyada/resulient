          ...
          <div className="relative px-8 py-20 text-center">
            <div className="max-w-4xl mx-auto">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
                ...
                <span className="text-white font-bold text-lg">SMART JOB MATCHING</span>
                <Sparkles className="h-5 w-5 text-yellow-300 animate-pulse" />
              </div>
              ...
              <p className="text-2xl text-white/95 max-w-4xl mx-auto mb-12 leading-relaxed">
                We're building an <span className="font-bold text-yellow-300">advanced</span> AI-powered job matching platform 
                that will <span className="font-bold text-orange-300">transform</span> how you find and apply to jobs.
              </p>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Advanced job matching that connects you with opportunities that truly fit your skills and experience.
            </p>
          </div>
