...
export const ResumeScoreCard = ({ scoreData }: ResumeScoreCardProps) => {
  ...
  return (
    <div className="w-full max-w-xs sm:max-w-md mx-auto relative scorecard-for-export">
      {/* Enhanced Card with Modern Design - Mobile optimized */}
      <Card className="overflow-hidden bg-gradient-to-br from-white via-blue-50/80 to-indigo-100/60 dark:from-gray-900 dark:via-blue-950/80 dark:to-indigo-950/60 shadow-2xl border-0 relative">
        ...
        {/* Enhanced Header with Modern Profile Section - Mobile optimized */}
        <div className="relative z-10 pt-4 sm:pt-8 pb-2 sm:pb-4 px-3 sm:px-6">
          <div className="flex flex-col items-center space-y-2 sm:space-y-4">
            ...
            <div className="text-center space-y-1 sm:space-y-2">
              ...
              {profile?.job_title && (
                <Badge className="bg-gradient-to-r from-blue-500 to-purple-600 text-white border-0 shadow-lg text-xs sm:text-sm px-2 py-1">
        ...
        <CardContent className="py-3 sm:py-6 px-3 sm:px-6 relative z-10">
          {/* Enhanced Score Display - Mobile optimized */}
          <div className="text-center mb-3 sm:mb-6">
            ...
            <div className="mt-2 sm:mt-4">
              ...
              <Badge className={`mt-1 sm:mt-2 bg-gradient-to-r ${getScoreGradient(scoreData.overallScore)} text-white border-0 shadow-lg text-xs sm:text-sm px-2 py-1`}>
          ...
          <div className="grid grid-cols-1 gap-2 sm:gap-4 mt-3 sm:mt-6">
            <ScoreMetric
          ...
          <div className="mt-3 sm:mt-6">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 rounded-xl p-2 sm:p-4 border border-blue-100 dark:border-blue-800">
              <div className="flex items-center gap-1 sm:gap-2 mb-2 sm:mb-3">
                <Award className="h-3 w-3 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-400" />
                <h4 className="font-semibold text-blue-800 dark:text-blue-300 text-xs sm:text-sm">Suggested Skills to Add</h4>
              </div>
              <div className="text-xs sm:text-sm font-medium text-blue-700 dark:text-blue-300 pdf-skills-text leading-relaxed">
