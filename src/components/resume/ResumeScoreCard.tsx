...
export const ResumeScoreCard = ({ scoreData }: ResumeScoreCardProps) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto relative scorecard-for-export">
      ...
      <Card className="overflow-hidden bg-gradient-to-br from-white via-blue-50/80 to-indigo-100/60 dark:from-gray-900 dark:via-blue-950/80 dark:to-indigo-950/60 shadow-2xl border-0 relative">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-blue-200/30 to-purple-200/30 dark:from-blue-800/20 dark:to-purple-800/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute -bottom-20 -left-20 w-32 h-32 bg-gradient-to-tr from-emerald-200/30 to-teal-200/30 dark:from-emerald-800/20 dark:to-teal-800/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>

        {/* Enhanced Header with Modern Profile Section */}
        <div className="relative z-10 pt-8 pb-4 px-6">
          <div className="flex flex-col items-center space-y-4">
            {shouldShowAvatar && (
              <div className="relative">
                <div className={`absolute inset-0 rounded-full bg-gradient-to-r ${getScoreGradient(scoreData.overallScore)} p-1 animate-pulse`}>
                  <div className="w-full h-full rounded-full bg-white dark:bg-gray-900"></div>
                </div>
                <Avatar className="pdf-avatar w-20 h-20 relative border-4 border-white dark:border-gray-800 shadow-xl">
                  <AvatarImage
        ...
        <CardContent className="py-6 px-6 relative z-10">
          ...
          <div className="text-center mb-6">
            ...
            <div className="mt-4">
              ...
              <Badge className={`mt-2 bg-gradient-to-r ${getScoreGradient(scoreData.overallScore)} text-white border-0 shadow-lg`}>
          ...
          <div className="mt-6">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 rounded-xl p-4 border border-blue-100 dark:border-blue-800">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-semibold text-blue-800 dark:text-blue-300">Suggested Skills to Add</h4>
              </div>
              <div className="text-sm font-medium text-blue-700 dark:text-blue-300 pdf-skills-text leading-relaxed">
          ...
          <div className="mt-6 space-y-3">
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/50 rounded-lg p-3 text-center border border-gray-200 dark:border-gray-700">
