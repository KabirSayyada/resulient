  ...
  return (
    <div className="section-card transition-all group hover:shadow-xl">
      ...
      <Textarea
        ...
        className="min-h-[150px] font-mono text-sm bg-white/80 border border-fuchsia-100 rounded-lg shadow-inner focus:ring-2 focus:ring-indigo-300 focus:border-fuchsia-500 transition-all resize-y"
